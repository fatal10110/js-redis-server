...
export function createCommandRegistry(
  ...
  registry.registerAll([
    new GetCommandDefinition(),
    new SetCommandDefinition(),
    new MgetCommandDefinition(),
    new MsetCommandDefinition(),
    new MsetnxCommandDefinition(),
    new GetsetCommandDefinition(),
    new AppendCommandDefinition(),
    new StrlenCommandDefinition(),
    new IncrCommandDefinition(),
    new DecrCommandDefinition(),
    new IncrbyCommandDefinition(),
    new DecrbyCommandDefinition(),
    new IncrbyfloatCommandDefinition(),
    new SetnxCommandDefinition(),
    new SetexCommandDefinition(),
    new PsetexCommandDefinition(),
    new GetdelCommandDefinition(),
    new GetexCommandDefinition(),
    new SetrangeCommandDefinition(),
    new GetrangeCommandDefinition(),
  ])

  // Register commands that have been migrated to the new metadata system
  registry.registerAll([
    // Key commands (13 commands)
    new DelCommandDefinition(),
    new ExistsCommandDefinition(),
    new TypeCommandDefinition(),
    new TtlCommandDefinition(),
    new PttlCommandDefinition(),
    new ExpireCommandDefinition(),
    new ExpireatCommandDefinition(),
    new FlushdbCommandDefinition(),
    new FlushallCommandDefinition(),
    new DbSizeCommandDefinition(),
    new RenameCommandDefinition(),
    new RenamenxCommandDefinition(),
    new PersistCommandDefinition(),
  ])

  registry.registerAll([
    // List commands (13 commands)
    new LpushCommandDefinition(),
    new RpushCommandDefinition(),
    new LpopCommandDefinition(),
    new RpopCommandDefinition(),
    new LlenCommandDefinition(),
    new LrangeCommandDefinition(),
    new LindexCommandDefinition(),
    new LsetCommandDefinition(),
    new LremCommandDefinition(),
    new LtrimCommandDefinition(),
    new LpushxCommandDefinition(),
    new RpushxCommandDefinition(),
    new RpoplpushCommandDefinition(),

    // Set commands (14 commands)
    new SaddCommandDefinition(),
    new SremCommandDefinition(),
    new ScardCommandDefinition(),
    new SmembersCommandDefinition(),
    new SismemberCommandDefinition(),
    new SpopCommandDefinition(),
    new SrandmemberCommandDefinition(),
    new SdiffCommandDefinition(),
    new SinterCommandDefinition(),
    new SunionCommandDefinition(),
    new SmoveCommandDefinition(),
    new SdiffstoreCommandDefinition(),
    new SinterstoreCommandDefinition(),
    new SunionstoreCommandDefinition(),

    // Sorted set commands (14 commands)
    new ZaddCommandDefinition(),
    new ZremCommandDefinition(),
    new ZrangeCommandDefinition(),
    new ZrevrangeCommandDefinition(),
    new ZrankCommandDefinition(),
    new ZrevrankCommandDefinition(),
    new ZscoreCommandDefinition(),
    new ZcardCommandDefinition(),
    new ZincrbyCommandDefinition(),
    new ZrangebyscoreCommandDefinition(),
    new ZremrangebyscoreCommandDefinition(),
    new ZcountCommandDefinition(),
    new ZpopminCommandDefinition(),
    new ZpopmaxCommandDefinition(),

    // Hash commands (14 commands)
    new HsetCommandDefinition(),
    new HsetnxCommandDefinition(),
    new HgetCommandDefinition(),
    new HdelCommandDefinition(),
    new HgetallCommandDefinition(),
    new HmgetCommandDefinition(),
    new HmsetCommandDefinition(),
    new HkeysCommandDefinition(),
    new HvalsCommandDefinition(),
    new HlenCommandDefinition(),
    new HexistsCommandDefinition(),
    new HincrbyCommandDefinition(),
    new HincrbyfloatCommandDefinition(),
    new HstrlenCommandDefinition(),

    // Server/connection commands
    new PingCommandDefinition(),
    new InfoCommandDefinition(),
    new QuitCommandDefinition(),
    new MonitorCommandDefinition(),
    new CommandInfoDefinition(),
    new ClientCommandDefinition(),
    new ClientSetNameCommandDefinition(),

    // Script commands
    new ScriptCommandDefinition(),
    new ScriptLoadCommandDefinition(),
    new ScriptExistsCommandDefinition(),
    new ScriptFlushCommandDefinition(),
    new ScriptKillCommandDefinition(),
    new ScriptDebugCommandDefinition(),
    new ScriptHelpCommandDefinition(),
    new EvalCommandDefinition(),
    new EvalShaCommandDefinition(),
  ])

  if (deps.discoveryService && deps.mySelfId) {
    registry.registerAll([
      new ClusterCommandDefinition(),
